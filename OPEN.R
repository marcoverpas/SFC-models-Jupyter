...
#g_n=matrix(data=0,nrow=3,ncol=nPeriods) #Government expenditure, Country N
#g_s=matrix(data=0,nrow=3,ncol=nPeriods) #Government expenditure, Country S
...
#p_g_bar=matrix(data=0,nrow=3,ncol=nPeriods) #Price of gold, set exogenously
...
#r_bar_n=matrix(data=0,nrow=3,ncol=nPeriods) #Interest rate on bills set exogenously in Country N
#r_bar_s=matrix(data=0,nrow=3,ncol=nPeriods) #Interest rate on bills set exogenously in Country S
...
#xr_bar=matrix(data=0,nrow=3,ncol=nPeriods) #Exchange rate, set exogenously
